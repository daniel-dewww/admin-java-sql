...
public class JIF_Eliminar extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DNI de Conductora:");
    ...
    private void btnEliminarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEliminarMouseClicked
        try {
            ...
            String SQL =    "DELETE FROM tbl_Conductores WHERE docConductor = " + Integer.parseInt(txtDni.getText());
            ...
            JOptionPane.showMessageDialog(null, "Conductora Eliminada Correctamente");
